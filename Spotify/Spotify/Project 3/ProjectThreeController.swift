//
//  ProjectThreeController.swift
//  Spotify
//
//  Created by Harold Davidson on 10/13/24.
//

import UIKit

class ProjectThreeController: UIViewController {
    // MARK: - Spotify Authorization & Configuration
        ...
        @objc func didTapConnect(_ button: UIButton) {
            ...
            #warning("Changed this to include the campaign parameter")
    ...
    // MARK: Style & Layout
    extension ProjectThreeController {
        func style() {
    ...
    extension ProjectThreeController: SPTAppRemoteDelegate {
    ...
    extension ProjectThreeController: SPTAppRemotePlayerStateDelegate {
    ...
    extension ProjectThreeController: SPTSessionManagerDelegate {
