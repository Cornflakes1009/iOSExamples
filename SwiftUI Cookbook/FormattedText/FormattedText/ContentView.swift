...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("Use kerning to change space between characters in one text")
                .kerning(7)
            Text("Changing baseline offset")
                .baselineOffset(100)
            Text("Strikethrough")
                .strikethrough()
            Text("This is a multi-line text implemented in SwiftUI. The trailing modifier was added to the text. This text also implements multiple modifiers")
                .background(.yellow)
